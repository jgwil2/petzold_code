...
class TestAdders(unittest.TestCase):
    ...
    def test_full_adder(self):
        ...
        full_adder.input_a.setExternalPin(1)
        full_adder.input_b.setExternalPin(1)
        full_adder.input_carry.setExternalPin(1)
        self.assertEqual(
    ...
    def test_eight_bit_adder(self):
        ...
        eight_bit_adder.input_a_0.setExternalPin(1)
        eight_bit_adder.input_b_0.setExternalPin(1)
        ...
        eight_bit_adder.input_a_1.setExternalPin(1)
        eight_bit_adder.input_a_2.setExternalPin(1)
        eight_bit_adder.input_a_3.setExternalPin(1)
        eight_bit_adder.input_a_4.setExternalPin(1)
        eight_bit_adder.input_a_5.setExternalPin(1)
        eight_bit_adder.input_b_1.setExternalPin(1)
        eight_bit_adder.input_b_5.setExternalPin(1)
